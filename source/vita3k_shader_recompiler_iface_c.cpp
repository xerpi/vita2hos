...
static shader::GeneratedShader convert_gxp_internal(
	const SceGxmProgram *program, const char *shader_name,
	...
	shader::Target target)
{
	...
	return shader::convert_gxp(*program, std::string(shader_name), features, target, hints, maskupdate, force_shader_debug, dumper_f);
}
			    ...
			    bool maskupdate, bool force_shader_debug, bool (*dumper)(const char *ext, const char *dump))
{
	...
	shader = convert_gxp_internal(program, shader_name, support_shader_interlock, support_texture_barrier,
				      direct_fragcolor, spirv_shader, hint_attributes, num_hint_attributes,
				      maskupdate, force_shader_debug, dumper, shader::Target::SpirVOpenGL);
			   ...
			   bool maskupdate, bool force_shader_debug, bool (*dumper)(const char *ext, const char *dump))
{
	...
	shader = convert_gxp_internal(program, shader_name, support_shader_interlock, support_texture_barrier,
				      direct_fragcolor, spirv_shader, hint_attributes, num_hint_attributes,
				      maskupdate, force_shader_debug, dumper, shader::Target::GLSLOpenGL);
