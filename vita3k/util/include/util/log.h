...
extern "C" {
extern void LOGSTR(const char *s);
...
#define LOG_TRACE(...) LOG(fmt::format(__VA_ARGS__))
#define LOG_DEBUG(...) LOG(fmt::format(__VA_ARGS__))
#define LOG_INFO(...) LOG(fmt::format(__VA_ARGS__))
#define LOG_WARN(...) LOG(fmt::format(__VA_ARGS__))
#define LOG_ERROR(...) LOG(fmt::format(__VA_ARGS__))
#define LOG_CRITICAL(...) LOG(fmt::format(__VA_ARGS__))
